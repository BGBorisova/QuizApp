...
class QuestionGenerator {
    ...
    fun getFirstModuleQuestions() = listOf(
        Question(
            id = 1,
            "Десетичният запис на числото 10011011 е:",
            listOf(
                Answer(1, "155", true),
                Answer(2, "156", false),
                Answer(3, "911", false),
    ...
    fun getSixthModuleQuestions() = listOf(
        ...
        Question(
            id = 6, "Кое твърдение е вярно за програмния фрагмент?\n" +
                ...
                Answer(4, "Индексите на елементите са цели отрицателни числа", false)
            )
        ),
        Question(
            id = 6,
